...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MessageQueue_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MessageQueue_t qt_meta_stringdata_MessageQueue = {
    {
QT_MOC_LITERAL(0, 0, 12), // "MessageQueue"
QT_MOC_LITERAL(1, 13, 14), // "sigDataChanged"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 3), // "num"
QT_MOC_LITERAL(4, 33, 15), // "sigEmployeeData"
QT_MOC_LITERAL(5, 49, 13), // "EmployeeGrade"
QT_MOC_LITERAL(6, 63, 5) // "grade"

    },
    "MessageQueue\0sigDataChanged\0\0num\0"
    "sigEmployeeData\0EmployeeGrade\0grade"
};
...
void MessageQueue::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigDataChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->sigEmployeeData((*reinterpret_cast< EmployeeGrade(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageQueue::sigDataChanged)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessageQueue::sigEmployeeData)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MessageQueue::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_MessageQueue.data,
